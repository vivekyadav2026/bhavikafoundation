...
?>
    ...
    <header class="page-header bg-white">
        <div class="container" data-aos="fade-up">
            ...
            <p class="lead text-muted mx-auto" style="max-width: 700px; font-size: 1.05rem;">We drive sustainable change through 8 core focus areas, working tirelessly for the betterment of society, rural development, and human welfare.</p>
        </div>
    </header>
        ...
        <div class="container position-relative z-1">
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="p-5 bg-white rounded-4 border-top border-primary border-4 shadow-sm h-100 transition-all hover-translate-up">
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="p-5 bg-white rounded-4 border-top border-danger border-4 shadow-sm h-100 transition-all hover-translate-up">
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="p-5 bg-white rounded-4 border-top border-success border-4 shadow-sm h-100 transition-all hover-translate-up">
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                    <div class="p-5 bg-white rounded-4 border-top border-warning border-4 shadow-sm h-100 transition-all hover-translate-up">
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="700">
                    <div class="p-5 bg-white rounded-4 border-top border-info border-4 shadow-sm h-100 transition-all hover-translate-up">
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="800">
                    <div class="p-5 bg-white rounded-4 border-top border-secondary border-4 shadow-sm h-100 transition-all hover-translate-up">
    ...
    <section class="section-padding bg-dark text-white text-center position-relative overflow-hidden">
        ...
        <div class="container position-relative z-1" data-aos="zoom-in">
            <h2 class="text-white mb-4">Together, We Can Create Lasting Change</h2>
            <p class="lead text-white-50 mb-5 mx-auto" style="max-width: 600px;">Join our mission to build a better tomorrow across all our 8 focus areas. Your impact matters.</p>
            <div class="d-flex justify-content-center gap-4">
                <a href="donate.php" class="btn btn-pill btn-pill-accent px-5">Support Us</a>
                <a href="contact.php" class="btn btn-pill btn-pill-outline text-white border-white border-opacity-25 px-5">Contact Us</a>
            </div>
        </div>
    </section>
